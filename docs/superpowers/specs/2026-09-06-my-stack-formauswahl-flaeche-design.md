...
Zweiter Anlauf. Der erste (a0721fd) gab jeder Form ihre eigene gerahmte Kachel
und wurde verworfen. Vierzehn gerahmte Kacheln lesen sich als vierzehn
...
| Nicht gewählt | Fokus 0,62 statt 1 | Gedimmt mit demselben Regler, den das Karussell benutzt — nicht mit einer Deckkraft über allem. Ganz aus wäre zu wenig: die Alternativen sollen erkennbar bleiben. |
