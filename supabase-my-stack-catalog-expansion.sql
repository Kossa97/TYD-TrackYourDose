...
with quelle (canonical_name, aliases, default_category, suggested_dosage_forms, suggested_units, pk_profile_name) as (
  values
    ...
    ('Magnesium', array['Magnesiumcitrat', 'Magnesium citrate', 'Magnesiumöl']::text[], 'supplement', array['capsule', 'tablet', 'powder', 'spray', 'drops']::text[], array['mg']::text[], null),
    ('Omega-3', array['Omega 3', 'Fischöl', 'Fish oil', 'EPA/DHA']::text[], 'supplement', array['capsule', 'drops']::text[], array['mg', 'g']::text[], null),
    ...
    ('Zink', array['Zinc', 'Zinkgluconat', 'Zinkbisglycinat', 'Zinkpicolinat']::text[], 'supplement', array['tablet', 'capsule', 'drops']::text[], array['mg']::text[], null),
    ...
    ('Ibuprofen', array['Nurofen']::text[], 'medication', array['tablet', 'capsule', 'gel', 'tube']::text[], array['mg']::text[], 'Ibuprofen'),
    ...
    ('Progesteron', array['Progesterone', 'Utrogest']::text[], 'hormone', array['capsule', 'tablet', 'gel', 'tube']::text[], array['mg']::text[], 'Progesteron'),
    ('Diclofenac', array['Voltaren', 'Diclo']::text[], 'medication', array['gel', 'tube', 'tablet', 'patch']::text[], array['mg']::text[], null),
    ('Ketoprofen', array['Gabrilen']::text[], 'medication', array['gel', 'tube']::text[], array['mg']::text[], null),
    ('Heparin', array['Heparin-Salbe', 'Heparinoid']::text[], 'medication', array['gel', 'tube']::text[], array['mg']::text[], null),
    ('Lidocain', array['Lidocaine', 'Xylocain']::text[], 'medication', array['gel', 'tube', 'spray', 'patch']::text[], array['mg']::text[], null),
    ('Capsaicin', array['Cayennepfeffer-Extrakt']::text[], 'medication', array['gel', 'tube', 'patch']::text[], array['mg']::text[], null),
    ('Hydrocortison', array['Hydrocortisone']::text[], 'medication', array['gel', 'tube', 'tablet']::text[], array['mg']::text[], null),
    ('Mometason', array['Mometasone', 'Nasonex']::text[], 'medication', array['gel', 'tube', 'nasal_spray']::text[], array['mcg', 'mg']::text[], null),
    ('Betamethason', array['Betamethasone']::text[], 'medication', array['gel', 'tube']::text[], array['mg']::text[], null),
    ('Tretinoin', array['Vitamin-A-Säure', 'Retinsäure']::text[], 'medication', array['gel', 'tube']::text[], array['mg']::text[], null),
    ('Adapalen', array['Adapalene', 'Differin']::text[], 'medication', array['gel', 'tube']::text[], array['mg']::text[], null),
    ('Benzoylperoxid', array['BPO', 'Benzoyl peroxide']::text[], 'medication', array['gel', 'tube']::text[], array['mg']::text[], null),
    ('Azelainsäure', array['Azelaic acid', 'Skinoren']::text[], 'medication', array['gel', 'tube']::text[], array['mg']::text[], null),
    ('Clotrimazol', array['Clotrimazole', 'Canesten']::text[], 'medication', array['gel', 'tube']::text[], array['mg']::text[], null),
    ('Tacrolimus', array['Protopic']::text[], 'medication', array['gel', 'tube']::text[], array['mg']::text[], null),
    ('Minoxidil', array['Regaine', 'Rogaine']::text[], 'medication', array['spray', 'drops', 'gel', 'tablet']::text[], array['mg']::text[], null),
    ('Dexpanthenol', array['Bepanthen', 'Panthenol']::text[], 'medication', array['gel', 'tube', 'drops']::text[], array['mg']::text[], null),
    ('Zinkoxid', array['Zinksalbe', 'Zinc oxide']::text[], 'medication', array['gel', 'tube']::text[], array['mg']::text[], null),
    ('Arnika', array['Arnica montana', 'Bergwohlverleih']::text[], 'supplement', array['gel', 'tube']::text[], array['mg']::text[], null),
    ('Beinwell', array['Symphytum', 'Wallwurz']::text[], 'supplement', array['gel', 'tube']::text[], array['mg']::text[], null),
    ('Aloe Vera', array['Aloe']::text[], 'supplement', array['gel', 'tube', 'drops']::text[], array['mg', 'g']::text[], null),
    ('Kamille', array['Matricaria', 'Chamomilla']::text[], 'supplement', array['drops', 'gel', 'tube']::text[], array['mg']::text[], null),
    ('Nikotin', array['Nicotine', 'Nicorette', 'Nikotinersatz']::text[], 'medication', array['patch', 'spray']::text[], array['mg']::text[], null),
    ('Fentanyl', array['Durogesic']::text[], 'medication', array['patch']::text[], array['mcg']::text[], null),
    ('Buprenorphin', array['Buprenorphine', 'Transtec', 'Norspan']::text[], 'medication', array['patch', 'tablet']::text[], array['mcg', 'mg']::text[], null),
    ('Scopolamin', array['Scopoderm', 'Hyoscin']::text[], 'medication', array['patch']::text[], array['mg']::text[], null),
    ('Rivastigmin', array['Rivastigmine', 'Exelon']::text[], 'medication', array['patch', 'capsule']::text[], array['mg']::text[], null),
    ('Rotigotin', array['Rotigotine', 'Neupro']::text[], 'medication', array['patch']::text[], array['mg']::text[], null),
    ('Xylometazolin', array['Xylometazoline', 'Otriven', 'Olynth']::text[], 'medication', array['nasal_spray']::text[], array['mg', 'mcg']::text[], null),
    ('Oxymetazolin', array['Oxymetazoline', 'Nasivin']::text[], 'medication', array['nasal_spray']::text[], array['mg', 'mcg']::text[], null),
    ('Fluticason', array['Fluticasone', 'Flutide', 'Avamys']::text[], 'medication', array['nasal_spray', 'spray']::text[], array['mcg']::text[], null),
    ('Azelastin', array['Azelastine', 'Vividrin']::text[], 'medication', array['nasal_spray', 'drops']::text[], array['mcg', 'mg']::text[], null),
    ('Budesonid', array['Budesonide', 'Pulmicort']::text[], 'medication', array['spray', 'nasal_spray', 'capsule']::text[], array['mcg']::text[], null),
    ('Salbutamol', array['Albuterol', 'Sultanol', 'Ventolin']::text[], 'medication', array['spray']::text[], array['mcg']::text[], null),
    ('Glyceroltrinitrat', array['Nitroglycerin', 'Nitrolingual', 'GTN']::text[], 'medication', array['spray', 'patch']::text[], array['mg']::text[], null),
    ('CBD', array['Cannabidiol', 'CBD-Öl']::text[], 'supplement', array['drops', 'capsule', 'spray']::text[], array['mg']::text[], null),
