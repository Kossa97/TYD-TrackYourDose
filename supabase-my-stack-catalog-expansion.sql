...
with quelle (canonical_name, aliases, default_category, suggested_dosage_forms, suggested_units, pk_profile_name) as (
  values
    ...
    ('Koffein', array['Caffeine', 'Coffein']::text[], 'supplement', array['tablet', 'capsule']::text[], array['mg']::text[], null),
    ('L-Theanin', array['Theanin', 'L-Theanine']::text[], 'supplement', array['capsule', 'tablet', 'powder']::text[], array['mg']::text[], null),
    ...
    ('NAC', array['N-Acetyl-Cystein', 'N-Acetylcystein', 'Acetylcystein']::text[], 'supplement', array['capsule', 'tablet']::text[], array['mg']::text[], null),
    ...
    ('5-HTP', array['5-Hydroxytryptophan', 'Griffonia']::text[], 'supplement', array['capsule', 'tablet']::text[], array['mg']::text[], null),
    ('Coenzym Q10', array['CoQ10', 'Ubiquinol', 'Ubichinon']::text[], 'supplement', array['capsule']::text[], array['mg']::text[], null),
    ...
    ('Berberin', array['Berberine', 'Berberin-HCl']::text[], 'supplement', array['capsule', 'tablet']::text[], array['mg']::text[], null),
    ...
    ('Ibuprofen', array['Nurofen']::text[], 'medication', array['tablet', 'capsule']::text[], array['mg']::text[], null),
    ('Paracetamol', array['Acetaminophen', 'Ben-u-ron']::text[], 'medication', array['tablet', 'capsule']::text[], array['mg']::text[], null),
    ('Acetylsalicylsäure', array['ASS', 'Aspirin']::text[], 'medication', array['tablet']::text[], array['mg']::text[], null),
    ('Pantoprazol', array['Pantoprazole', 'Pantozol']::text[], 'medication', array['tablet']::text[], array['mg']::text[], null),
    ('Omeprazol', array['Omeprazole']::text[], 'medication', array['capsule', 'tablet']::text[], array['mg']::text[], null),
    ('Atorvastatin', array['Sortis']::text[], 'medication', array['tablet']::text[], array['mg']::text[], null),
    ('Rosuvastatin', array['Crestor']::text[], 'medication', array['tablet']::text[], array['mg']::text[], null),
    ('Simvastatin', array['Zocor']::text[], 'medication', array['tablet']::text[], array['mg']::text[], null),
    ('Ramipril', array['Delix']::text[], 'medication', array['tablet', 'capsule']::text[], array['mg']::text[], null),
    ('Bisoprolol', array['Concor']::text[], 'medication', array['tablet']::text[], array['mg']::text[], null),
    ('Metoprolol', array['Beloc']::text[], 'medication', array['tablet']::text[], array['mg']::text[], null),
    ('Amlodipin', array['Amlodipine', 'Norvasc']::text[], 'medication', array['tablet', 'capsule']::text[], array['mg']::text[], null),
    ('Candesartan', array['Blopress']::text[], 'medication', array['tablet']::text[], array['mg']::text[], null),
    ('Sertralin', array['Sertraline', 'Zoloft']::text[], 'medication', array['tablet']::text[], array['mg']::text[], null),
    ('Escitalopram', array['Cipralex']::text[], 'medication', array['tablet']::text[], array['mg']::text[], null),
    ('Venlafaxin', array['Venlafaxine', 'Trevilor']::text[], 'medication', array['capsule', 'tablet']::text[], array['mg']::text[], null),
    ('Bupropion', array['Elontril', 'Wellbutrin']::text[], 'medication', array['tablet']::text[], array['mg']::text[], null),
    ('Methylphenidat', array['Methylphenidate', 'Ritalin', 'Medikinet', 'Concerta']::text[], 'medication', array['tablet', 'capsule']::text[], array['mg']::text[], null),
    ('Lisdexamfetamin', array['Lisdexamfetamine', 'Elvanse', 'Vyvanse']::text[], 'medication', array['capsule']::text[], array['mg']::text[], null),
    ('Modafinil', array['Vigil', 'Provigil']::text[], 'medication', array['tablet']::text[], array['mg']::text[], null),
    ('Finasterid', array['Finasteride', 'Propecia']::text[], 'medication', array['tablet']::text[], array['mg']::text[], null),
    ('Dutasterid', array['Dutasteride', 'Avodart']::text[], 'medication', array['capsule']::text[], array['mg']::text[], null),
    ('Tadalafil', array['Cialis']::text[], 'medication', array['tablet']::text[], array['mg']::text[], null),
    ('Sildenafil', array['Viagra']::text[], 'medication', array['tablet']::text[], array['mg']::text[], null),
    ('Anastrozol', array['Anastrozole', 'Arimidex']::text[], 'medication', array['tablet']::text[], array['mg']::text[], null),
    ('Tamoxifen', array['Nolvadex']::text[], 'medication', array['tablet']::text[], array['mg']::text[], null),
    ('Enclomifen', array['Enclomiphene', 'Enclomifencitrat']::text[], 'medication', array['capsule', 'tablet']::text[], array['mg']::text[], null),
    ('Levothyroxin', array['Levothyroxine', 'L-Thyroxin', 'Euthyrox', 'T4']::text[], 'medication', array['tablet']::text[], array['mcg']::text[], null),
    ('Liothyronin', array['Liothyronine', 'T3', 'Thybon']::text[], 'medication', array['tablet']::text[], array['mcg']::text[], null),
    ('Allopurinol', array['Zyloric']::text[], 'medication', array['tablet']::text[], array['mg']::text[], null),
    ('Cetirizin', array['Cetirizine', 'Zyrtec']::text[], 'medication', array['tablet']::text[], array['mg']::text[], null),
    ('Loratadin', array['Loratadine', 'Lorano']::text[], 'medication', array['tablet']::text[], array['mg']::text[], null),
    ('Prednisolon', array['Prednisolone', 'Decortin H']::text[], 'medication', array['tablet']::text[], array['mg']::text[], null),
    ('Amoxicillin', array['Amoxi']::text[], 'medication', array['capsule', 'tablet']::text[], array['mg']::text[], null),
    ('Dapagliflozin', array['Forxiga', 'Farxiga']::text[], 'medication', array['tablet']::text[], array['mg']::text[], null),
    ('Empagliflozin', array['Jardiance']::text[], 'medication', array['tablet']::text[], array['mg']::text[], null),
    ('Naltrexon', array['Naltrexone', 'LDN', 'Low Dose Naltrexone']::text[], 'medication', array['tablet', 'capsule']::text[], array['mg']::text[], null),
    ('Rapamycin', array['Sirolimus', 'Rapamune']::text[], 'medication', array['tablet']::text[], array['mg']::text[], null),
    ('DHEA', array['Dehydroepiandrosteron', 'Prasteron']::text[], 'hormone', array['capsule', 'tablet']::text[], array['mg']::text[], null),
    ('Pregnenolon', array['Pregnenolone']::text[], 'hormone', array['capsule', 'tablet']::text[], array['mg']::text[], null),
    ('Östradiol', array['Estradiol', 'Oestradiol', 'Estrogel']::text[], 'hormone', array['tablet', 'gel', 'patch']::text[], array['mg', 'mcg']::text[], null),
    ('Progesteron', array['Progesterone', 'Utrogest']::text[], 'hormone', array['capsule', 'tablet']::text[], array['mg']::text[], null)
),
aufgeloest as (
  select
