...
it('includes all 134 public routes and reciprocal language links', () => {
  expect(peptipediaRouteManifest()).toHaveLength(134)
  expect(new Set(peptipediaRouteManifest().map(route => route.path)).size).toBe(134)
