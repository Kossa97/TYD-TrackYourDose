...
export const DOSAGE_FORMS: readonly DosageFormDefinition[] = [
  ...
  { key: 'ampoule', labelKey: 'dosage_form_ampoule', suggestedUnits: ['mg', 'ml', 'IU'], basisUnits: ['ml', 'ampoule'], capabilities: ['injectable', 'liquid', 'concentration_based', 'inventory_capable'], showsColor: true, strengthShape: 'per_volume', intakeUnit: 'syringe', stageRenderer: 'ampoule', stageHeightRatio: 0.98, stageForm: AMPOULE_SPEC },
  { key: 'pen', labelKey: 'dosage_form_pen', suggestedUnits: ['mg', 'mcg', 'IU'], basisUnits: ['dose', 'ml'], capabilities: ['injectable', 'liquid', 'concentration_based', 'inventory_capable'], showsColor: true, strengthShape: 'per_volume', intakeUnit: 'dose', stageRenderer: 'pen', stageHeightRatio: 1, stageForm: PEN_SPEC },
  ...
  { key: 'drops', labelKey: 'dosage_form_drops', suggestedUnits: ['mcg', 'mg', 'IU', 'ml'], basisUnits: ['drop', 'ml'], capabilities: ['liquid', 'concentration_based', 'inventory_capable'], showsColor: true, strengthShape: 'per_volume', intakeUnit: 'drop', stageRenderer: 'drops', stageHeightRatio: 0.92, stageForm: DROPS_SPEC },
  { key: 'powder', labelKey: 'dosage_form_powder', suggestedUnits: ['mg', 'g'], basisUnits: ['g', 'portion'], capabilities: ['inventory_capable'], showsColor: true, strengthShape: 'per_mass', intakeUnit: 'portion', stageRenderer: 'powder', stageHeightRatio: 0.86, stageForm: POWDER_SPEC },
  { key: 'nasal_spray', labelKey: 'dosage_form_nasal_spray', suggestedUnits: ['mcg', 'mg'], basisUnits: ['spray'], capabilities: ['countable', 'liquid', 'inventory_capable'], showsColor: true, strengthShape: 'per_unit', intakeUnit: 'spray', stageRenderer: 'nasal_spray', stageHeightRatio: 0.96, stageForm: NASAL_SPRAY_SPEC },
  { key: 'spray', labelKey: 'dosage_form_spray', suggestedUnits: ['mcg', 'mg', 'ml'], basisUnits: ['spray'], capabilities: ['countable', 'liquid', 'inventory_capable'], showsColor: true, strengthShape: 'per_unit', intakeUnit: 'spray', stageRenderer: 'spray', stageHeightRatio: 0.9, stageForm: SPRAY_SPEC },
  ...
  { key: 'tube', labelKey: 'dosage_form_tube', suggestedUnits: ['mg', 'g', 'ml'], basisUnits: ['g', 'ml', 'application'], capabilities: ['inventory_capable'], showsColor: false, strengthShape: 'per_mass', intakeUnit: 'application', stageRenderer: 'tube', stageHeightRatio: 0.94, stageForm: TUBE_SPEC },
