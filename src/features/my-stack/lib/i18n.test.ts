...
const EXPECTED_MY_STACK_KEYS = [
  ...
  'my_stack_plan_open_overview',
  'my_stack_plan_since_day',
  'my_stack_plan_next_step',
  ...
  'due_intakes_hint',
  'my_stack_stock_title',
  'my_stack_stock_close',
  'my_stack_stock_not_tracked',
  'my_stack_stock_start_hint',
  'my_stack_stock_start',
  'my_stack_stock_package_size',
  'my_stack_stock_unit',
  'my_stack_stock_current',
  'my_stack_stock_add_package',
  'my_stack_stock_add_amount',
  'my_stack_stock_correct',
  'my_stack_stock_mixed_extra',
  'my_stack_stock_opened_extra',
  'my_stack_stock_package_line',
  'my_stack_stock_range_days_single',
  'my_stack_stock_range_days_multiple',
  'my_stack_stock_range_longer',
  'my_stack_stock_range_no_plan',
  'my_stack_stock_range_unknown',
  'my_stack_stock_empty',
  'my_stack_stock_needs_strength',
  'my_stack_stock_opened_vial',
  'my_stack_stock_opened_pen',
  'my_stack_stock_opened_bottle',
  'my_stack_stock_mixed_on',
  'my_stack_stock_opened_on',
  'my_stack_stock_liquid',
  'my_stack_stock_use_within_vial',
  'my_stack_stock_use_within',
  'my_stack_stock_days_single',
  'my_stack_stock_days_multiple',
  'my_stack_stock_until',
  'my_stack_stock_mix_new',
  'my_stack_stock_open_new_pen',
  'my_stack_stock_open_new_bottle',
  'my_stack_stock_discard_rest',
  'my_stack_stock_batch',
  'my_stack_stock_batch_number',
  'my_stack_stock_source',
  'my_stack_stock_document',
  'my_stack_stock_document_pick',
  'my_stack_stock_document_show',
  'my_stack_stock_document_remove',
  'my_stack_stock_expires',
  'my_stack_stock_not_set',
  'my_stack_stock_save',
  'my_stack_stock_saved',
  'my_stack_stock_save_failed',
  'my_stack_stock_stop',
  'my_stack_stock_unit_vial_single',
  'my_stack_stock_unit_vial_multiple',
  'my_stack_stock_unit_tablet_single',
  'my_stack_stock_unit_tablet_multiple',
  'my_stack_stock_unit_capsule_single',
  'my_stack_stock_unit_capsule_multiple',
  'my_stack_stock_unit_drop_single',
  'my_stack_stock_unit_drop_multiple',
  'my_stack_stock_unit_ml_single',
  'my_stack_stock_unit_ml_multiple',
  'my_stack_stock_unit_spray_single',
  'my_stack_stock_unit_spray_multiple',
  'my_stack_stock_unit_dose_single',
  'my_stack_stock_unit_dose_multiple',
  'my_stack_stock_unit_patch_single',
  'my_stack_stock_unit_patch_multiple',
  'my_stack_stock_unit_g_single',
  'my_stack_stock_unit_g_multiple',
  'my_stack_stock_unit_portion_single',
  'my_stack_stock_unit_portion_multiple',
  'my_stack_stock_unit_application_single',
  'my_stack_stock_unit_application_multiple',
  'my_stack_stock_unit_ampoule_single',
  'my_stack_stock_unit_ampoule_multiple',
  'my_stack_stock_unit_unit_single',
  'my_stack_stock_unit_unit_multiple',
  'my_stack_stock_unit_hour_single',
  'my_stack_stock_unit_hour_multiple',
  'my_stack_plan_draw_units',
  'my_stack_plan_units_short',
  'my_stack_plan_units_note',
  'my_stack_product_only',
  'my_stack_plan_schedule_title',
  'my_stack_plan_schedule_change',
  'my_stack_plan_adopt_legend',
  'my_stack_plan_adopt_one',
  'my_stack_plan_adopt_many',
  'my_stack_plan_adopt_yes',
  'my_stack_plan_adopt_no',
] as const
