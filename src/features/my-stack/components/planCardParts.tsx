...
export function CurrentSlotRow({ slot, language, t }: { slot: PlanCardSlot; language: string; t: Translate }) {
...
export function StepSlotRow({ row, language, t }: { row: PlanStepRow; language: string; t: Translate }) {
