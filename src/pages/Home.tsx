...
import {
  ...
  BookHeart, Star, HelpCircle, User, ChevronRight, Syringe,
} from 'lucide-react'
...
const TILE_DEFS = [
  ...
  { icon: Syringe,      labelKey: 'tile_injektionen',descKey:'tile_injektionen_desc',path:'/injektionen3d',         color: '#a78bfa', bg: 'rgba(167,139,250,0.10)'        },
