...
export const ONBOARDING_STEPS: OnboardingStepMeta[] = [
  ...
  { id:'calendar-show', emoji:'📆', titleKey:'obx_calshow_title', subtitleKey:'obx_calshow_sub', descriptionKey:'obx_calshow_desc', targetSelector:'[data-ob="ob-cal-today"]', placement:'bottom', advance:'click', tapHintKey:'obx_calshow_tap', route:'/kalender' },
