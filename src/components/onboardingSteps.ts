...
export const ONBOARDING_STEPS: OnboardingStepMeta[] = [
  ...
  { id:'sim-confirm', emoji:'☑️', titleKey:'obx_simconfirm_title', subtitleKey:'obx_simconfirm_sub', descriptionKey:'obx_simconfirm_desc', targetSelector:'[data-ob="ob-sim-confirm"]', placement:'top', advance:'next', tapHintKey:'obx_simconfirm_tap', route:'/kalender', precondition:'sim' },
