...
## Corpus Check
- 827 files · ~993,683 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5812 nodes · 11682 edges · 463 communities (294 shown, 125 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 64 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `38e6a10a`
...
Cohesion: 0.06
Nodes (43): NewDot(), DoseUnitControl(), DoseUnitControlProps, StackArchive, StackArchiveProps, ./features/my-stack/MyStackPage, backfillMessageKey(), istIntervalUnit() (+35 more)
...
### Community 12 - "BlutspiegelCarousel.tsx"
Cohesion: 0.08
...
Cohesion: 0.08
Nodes (52): getStackItemColor(), InventoryConfirmationError, RoutineGroup, ConfirmedIntake, GROUP_LABEL_KEYS, RoutineConfirmationSheet(), RoutineConfirmationSheetProps, group() (+44 more)
...
Cohesion: 0.06
Nodes (40): clamp01(), clampFill(), clampSlosh(), PeptideVialVisual(), PeptideVialVisualProps, vialAmountLabel(), VialTop(), useSloshSubscribe() (+32 more)

### Community 19 - "wizardState.ts"
Cohesion: 0.11
Nodes (31): addSlot(), completeIngredient, defaultIntakeUnitFor(), getIntakePlanUnitSuggestions(), emptyRhythm(), basisVorbelegung(), canContinue(), didIdentityChange() (+23 more)
...
Cohesion: 0.12
Nodes (21): planSatz(), dateLabel(), DialogState, doseLabel(), HistoryRow(), PlanManagementSection(), PlanManagementSectionProps, rhythmLabel() (+13 more)
...
Cohesion: 0.06
Nodes (49): rhythmToStorage(), validateStackItemDraft(), PlanEditTarget, PlanEffectiveDraft, archiveStackItem(), deleteStackItem(), findDuplicate(), hatEigeneMengen() (+41 more)

### Community 33 - "compilerOptions"
Cohesion: 0.11
Nodes (17): compilerOptions, allowImportingTsExtensions, erasableSyntaxOnly, lib, module, moduleDetection, moduleResolution, noEmit (+9 more)

### Community 34 - "StackItemWizard.tsx"
Cohesion: 0.13
Nodes (24): useSloshEngine(), FOCUSABLE_SELECTOR, nextLocalDate(), pkIntentSteps(), StackItemWizard(), chooseSaveMode(), focusField(), handleBack() (+16 more)

### Community 35 - "StageLightHandle"
Cohesion: 0.08
Nodes (55): VialStageLightHandle, SloshContext, SloshProvider(), clamp(), createSloshEngine(), SloshEngine, SloshState, SpringState (+47 more)
...
Cohesion: 0.07
Nodes (49): @supabase/supabase-js, INJECTION_INTRO_VERSION, InjectionIntroSheet(), InjectionSaveInput, computeNextVialStock(), debitPeptideStockForDoseById(), doseToVialDelta(), roundStock() (+41 more)
...
### Community 43 - "BlutspiegelSimulation.tsx"
Cohesion: 0.09
Nodes (24): PkReadiness, useMediaQuery(), BlutspiegelSimulation(), CATEGORY_ACCENT, ChartPoint, computeSingleDose(), INPUT, LABEL (+16 more)
...
Cohesion: 0.07
Nodes (40): react-i18next, IngredientCatalogPicker(), IngredientCatalogPickerProps, IngredientChanges, IngredientEditor(), IngredientEditorProps, Aenderung, KATALOG (+32 more)
...
Cohesion: 0.13
Nodes (40): lucide-react, AuffaelligeWerte(), Props, Props, BefundListe(), isAuffaellig(), Layout, loadLayout() (+32 more)
...
### Community 95 - "OnboardingContext.tsx"
Cohesion: 0.16
...
Cohesion: 0.20
Nodes (15): isPanelNode(), Onboarding(), OB_Z, ObAdvance, ONBOARDING_STEPS, ONBOARDING_TOUR_STEP_COUNT, OnboardingStepMeta, getOnboardingHighlightRect() (+7 more)
...
Cohesion: 0.13
Nodes (26): [container, database], planVersionSegments(), versionBoundary(), CycleLifecycleStatus, hasReachedInstant(), instantMillis(), LOCAL_DATE_TIME_KEY_CACHE_MAX, localDateBoundaryCache (+18 more)
...
### Community 233 - "pkReadiness.ts"
Cohesion: 0.14
Nodes (20): FeatureFlag, FEATURES, evaluatePkReadiness(), mgPerMlFromStrength(), normalizedText(), resolvePkScheduleForDay(), readyInput, toPkMilligrams() (+12 more)
...
Cohesion: 0.08
Nodes (40): date-fns, InjectionDoseLog, treffer(), AUTO_MISSED_NOTE, collectMissedIntakes(), collectMissedTimelineIntakes(), collectOpenIntakes(), collectOpenTimelineIntakesForDate() (+32 more)
...
### Community 272 - "getDosageForm"
Cohesion: 0.15
Nodes (19): HINWEIS_FALLBACK, IngredientChanges, numericValue(), StrengthEditor(), BEISPIELMENGE, EINNAHMEN, LEVELS, TrackingLevelPicker() (+11 more)
...
### Community 279 - "react"
Cohesion: 0.10
Nodes (22): react, react-router-dom, @testing-library/react, App(), state, MechanismPanel(), OverviewPanel(), ProtocolsPanel() (+14 more)
...
### Community 288 - "dosageForms.ts"
Cohesion: 0.09
Nodes (33): VIAL_INNER_PATH, VIAL_OUTER_PATH, VIAL_SPEC, VIAL_WALL, TABLET_BODY, TABLET_BODY_NORMALIZED, TABLET_NAME_HALF_CHORD, TABLET_NAME_INSET_PCT (+25 more)
...
Cohesion: 0.09
Nodes (27): numberValue(), ProductInventorySection(), ProductInventorySectionProps, emptyInventory, buildDuplicateFingerprint(), ingredientFingerprint(), normalizeNumber(), normalizeText() (+19 more)
...
### Community 323 - "liveBlutspiegelChart.ts"
Cohesion: 0.10
...
### Community 329 - "DosageFormKey"
Cohesion: 0.06
Nodes (44): DosageFormCarousel(), beendeZug(), beiKlick(), beiRad(), beiScroll(), buehnenlichtMessen(), buehnenlichtPlanen(), fuehreZug() (+36 more)
...
### Community 340 - "__VialPreview.tsx"
Cohesion: 0.13
...
Cohesion: 0.13
Nodes (30): BlutwertePage(), EntryModal(), GridControls(), Props, SORT_LABELS, auffaelligeWerte(), buildMarkerSummaries(), computeTrend() (+22 more)
...
### Community 353 - "InjectionTrackerTabs.tsx"
Cohesion: 0.19
...
Cohesion: 0.11
Nodes (25): flacheStufe(), kuenftigeStufen(), PlanSegment, planSegments(), SegmentStatus, SLOT_ZEITEN, stufenText(), Cycle (+17 more)

### Community 372 - "stackSort.ts"
Cohesion: 0.47
Nodes (3): sortAbilities(), SortAbility, StackItemLike

### Community 373 - "stackTabs.ts"
Cohesion: 0.31
Nodes (6): filterByTab(), KATEGORIE_REITER, STACK_TABS, StackTab, StackTabKey, tabCounts()

### Community 374 - "PublicProfile.tsx"
Cohesion: 0.17
...
### Community 383 - "stackInventory.ts"
Cohesion: 0.29
...
### Community 395 - "getPublishedPeptide"
Cohesion: 0.38
...
## Knowledge Gaps
- **2174 isolated node(s):** `WEEKDAYS_DE`, `SLOT_TIMES`, `SLOT_GROUPS`, `CASES`, `FREQUENCY_CASES` (+2169 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 2761 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **125 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `react` connect `react` to `faq/types.ts`, `Protokoll.tsx`, `ProtocolPdfModal.tsx`, `AdminPanel.tsx`, `MyStackPage.tsx`, `InjectionLogSheet.tsx`, `BlutspiegelCarousel.tsx`, `StudyCard.tsx`, `chartMath.ts`, `Dashboard.tsx`, `PeptideVialVisual.tsx`, `FotosTab.tsx`, `PlanManagementSection.tsx`, `App.tsx`, `StackItemWizard.tsx`, `StageLightHandle`, `injectionPersistence.ts`, `Profil.tsx`, `useFortschrittData.ts`, `BlutspiegelSimulation.tsx`, `FortschrittPage.tsx`, `chartVisibility.ts`, `IntakePlanEditor.tsx`, `package.json`, `protocolPdf/types.ts`, `fortschritt/types.ts`, `react-i18next`, `CapsuleVisual.tsx`, `lucide-react`, `BottomNavigation.tsx`, `PatchVisual.tsx`, `PenVisual.tsx`, `InjectionMapCanvas.tsx`, `OnboardingContext.tsx`, `DesignSystem.tsx`, `Onboarding.tsx`, `BefundEditor.tsx`, `ArticleCards.tsx`, `FilterSheet.tsx`, `TodayLogSheet.tsx`, `pkReadiness.ts`, `Home.tsx`, `usePushNotifications.ts`, `Home.test.ts`, `GelVisual.tsx`, `AppBackNavigation.test.tsx`, `ColorField.tsx`, `VialTrackingEditor.tsx`, `Health.tsx`, `StackStage.test.ts`, `NasalSprayVisual.tsx`, `TheLab.tsx`, `DropsVisual.tsx`, `getDosageForm`, `SprayVisual.tsx`, `PowderVisual.tsx`, `routing.ts`, `TubeVisual.tsx`, `dosageForms.ts`, `MyStackPage.visibility.test.tsx`, `MetricChart.tsx`, `metrics.ts`, `my-stack/types.ts`, `Dashboard.test.ts`, `chartTooltip.ts`, `StageFit.test.tsx`, `liveBlutspiegelChart.ts`, `DosageFormKey`, `uiCopy.ts`, `__VialPreview.tsx`, `InjectionTrackerTabs.tsx`, `WorkflowBanner.tsx`, `StageDetailSheet.tsx`, `PublicProfile.tsx`, `VerlaufSection.tsx`, `StageLabel.tsx`, `CourseTimezoneReview.tsx`, `Layout.tsx`?**
  _High betweenness centrality (0.142) - this node is a cross-community bridge._
- **Why does `vitest` connect `vitest` to `ProtocolPdfModal.tsx`, `MyStackPage.tsx`, `blutspiegelHistory.ts`, `planLifecycle.ts`, `InjectionLogSheet.tsx`, `BlutspiegelCarousel.tsx`, `chartMath.ts`, `Dashboard.tsx`, `injectionHistory.ts`, `PeptideVialVisual.tsx`, `wizardState.ts`, `FotosTab.tsx`, `PlanManagementSection.tsx`, `planTimeline.js`, `intakeConfirmation.ts`, `stackItems.ts`, `StackItemWizard.tsx`, `StageLightHandle`, `injectionPersistence.ts`, `useFortschrittData.ts`, `BlutspiegelSimulation.tsx`, `injectionLogTypes.ts`, `FortschrittPage.tsx`, `chartVisibility.ts`, `IntakePlanEditor.tsx`, `substanceCatalog.ts`, `package.json`, `fortschritt/types.ts`, `react-i18next`, `chartData.test.ts`, `CapsuleVisual.tsx`, `BottomNavigation.tsx`, `PatchVisual.tsx`, `PenVisual.tsx`, `InjectionMapCanvas.tsx`, `planTimeline.ts`, `BefundEditor.tsx`, `TodayLogSheet.tsx`, `pkReadiness.ts`, `Home.test.ts`, `intakeSchedule.ts`, `progress-year-data.ts`, `GelVisual.tsx`, `AppBackNavigation.test.tsx`, `produktAngaben.ts`, `ColorField.tsx`, `VialTrackingEditor.tsx`, `legacyMyStackPersistence.ts`, `StackStage.test.ts`, `bloodwork-extract/index.ts`, `NasalSprayVisual.tsx`, `DropsVisual.tsx`, `getDosageForm`, `SprayVisual.tsx`, `react`, `PowderVisual.tsx`, `routing.ts`, `TubeVisual.tsx`, `audit-peptipedia.ts`, `dosageForms.ts`, `StackItemWizard.interaction.test.tsx`, `dosePlan.ts`, `MyStackPage.visibility.test.tsx`, `MetricChart.tsx`, `wellnessBuckets.ts`, `validate.ts`, `metrics.ts`, `colorMigration.ts`, `my-stack/types.ts`, `Dashboard.test.ts`, `chartTooltip.ts`, `i18n.test.ts`, `liquidGeometry.ts`, `StageFit.test.tsx`, `liveBlutspiegelChart.ts`, `DosageFormKey`, `uiCopy.ts`, `bloodwork.ts`, `InjectionTrackerTabs.tsx`, `StageDetailSheet.tsx`, `legacyPlanTimeline.ts`, `stackSort.ts`, `stackTabs.ts`, `stackInventory.ts`, `referenceBar.ts`, `StageLabel.tsx`, `CourseTimezoneReview.tsx`, `Layout.tsx`, `inventoryMath.ts`, `getPublishedPeptide`?**
  _High betweenness centrality (0.117) - this node is a cross-community bridge._
- **Why does `date-fns` connect `intakeSchedule.ts` to `TodayLogSheet.tsx`, `VialTrackingEditor.tsx`, `Health.tsx`, `Protokoll.tsx`, `MyStackPage.tsx`, `blutspiegelHistory.ts`, `InjectionLogSheet.tsx`, `BlutspiegelCarousel.tsx`, `chartMath.ts`, `Dashboard.tsx`, `injectionHistory.ts`, `wizardState.ts`, `FotosTab.tsx`, `planTimeline.js`, `seed-test-data.ts`, `dateLocales.ts`, `App.tsx`, `dosePlan.ts`, `injectionPersistence.ts`, `MyStackPage.visibility.test.tsx`, `MetricChart.tsx`, `useFortschrittData.ts`, `injectionLogTypes.ts`, `metrics.ts`, `FortschrittPage.tsx`, `chartTooltip.ts`, `package.json`, `fortschritt/types.ts`, `liveBlutspiegelChart.ts`, `lucide-react`, `InjectionTrackerTabs.tsx`, `pkReadiness.ts`, `Home.tsx`, `legacyPlanTimeline.ts`, `progress-year-data.ts`, `PublicProfile.tsx`?**
