...
## Corpus Check
- 579 files · ~663,091 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3674 nodes · 6770 edges · 322 communities (212 shown, 110 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 60 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `718a8202`
...
## Communities (322 total, 110 thin omitted)
...
Cohesion: 0.08
Nodes (34): CarouselCounter(), CarouselPagination(), getStackItemColor(), isInjectableMethod(), ResolvedRoutineGroup, buildDashboardRoutineIntake(), calendarLegendText, cycleIntakeMinutes() (+26 more)
...
Cohesion: 0.06
Nodes (30): alertMessage(), ExpiryWarningBanners(), InjectionHeroPin, InjectionCycleRow, ScheduleCycle, ExpiryStatus, getPeptideExpiryAlerts(), PeptideExpiryAlert (+22 more)
...
Cohesion: 0.09
Nodes (24): FeatureFlag, FEATURES, resolvePkScheduleForDay(), useMediaQuery(), BlutspiegelSimulation(), CATEGORY_ACCENT, ChartPoint, computeSingleDose() (+16 more)
...
Cohesion: 0.21
Nodes (14): isPanelNode(), Onboarding(), OB_Z, ObAdvance, ONBOARDING_STEPS, OnboardingStepMeta, getOnboardingHighlightRect(), getOnboardingInteractionEl() (+6 more)
...
Cohesion: 0.16
Nodes (10): InjectionIntroSheet(), InjectionSaveInput, findTargetInjectionIntake(), getOpenInjectionIntakeKey(), INJECTABLE_METHODS, OpenInjectionIntake, isTableMissingError(), NO_WARNING (+2 more)
...
Cohesion: 0.13
Nodes (22): IngredientChanges, IngredientEditor(), IngredientEditorProps, renderIngredientEditor(), renderSearch(), renderStrengthEditor(), twoIngredients, vitaminD3 (+14 more)
...
Cohesion: 0.12
Nodes (24): CycleWithPk, evaluatePkReadiness(), normalizedText(), PkReadiness, PkReadinessInput, PkScheduleCycle, readyInput, toPkMilligrams() (+16 more)
...
Cohesion: 0.20
Nodes (14): useSloshSubscribe(), TABLET_BODY, TABLET_BODY_NORMALIZED, TABLET_NAME_HALF_CHORD, TABLET_SCORE, TABLET_SPEC, TABLET_VIEWBOX, clamp01() (+6 more)
...
Cohesion: 0.19
Nodes (15): DOT_ROWS, PATCH_BODY, PATCH_DOTS, PATCH_NAME_PCT, PATCH_NAME_ZONE, PATCH_PAD, PATCH_SPEC, PATCH_VIEWBOX (+7 more)
...
Cohesion: 0.18
Nodes (17): SloshState, buildLiquid(), clamp(), fillSloshResponse(), finite(), LiquidGeometry, LiquidParams, liquidSurfaceY() (+9 more)
...
Cohesion: 0.09
Nodes (37): FOCUSABLE_SELECTOR, completeCatalogFlow(), completeCustomFlow(), continueWizard(), existingPlan, existingVitaminD, pkVitaminD3, reachExistingReview() (+29 more)
...
Cohesion: 0.11
Nodes (35): VialStageLightHandle, SloshContext, SloshProvider(), useSloshEngine(), clamp(), createSloshEngine(), SloshEngine, SpringState (+27 more)
...
Cohesion: 0.12
Nodes (18): ampouleAmountLabel(), AmpouleVisual(), AmpouleVisualProps, clamp01(), clampOffset(), SIZE_CLASS, base, render() (+10 more)
...
Cohesion: 0.11
Nodes (19): CameraRig(), focusTargetForRequest(), INJECTION_MAP_LIGHTS, InjectionMapCanvas(), LightPosition, OrbitControlsApi, resetCameraFrame(), Scene() (+11 more)
...
Cohesion: 0.20
Nodes (8): clamp01(), clampFill(), clampSlosh(), fillMotionShiftPct(), PeptideVialVisual(), PeptideVialVisualProps, vialAmountLabel(), VialTop()
...
Cohesion: 0.14
Nodes (17): formatTrackedQuantity(), fractionGlyphs, hasTrackedQuantity(), TrackedQuantity, confirmIntakeGroup(), ConfirmIntakeGroupRpcEntry, ConfirmIntakeGroupRpcParams, IntakeConfirmationClient (+9 more)

### Community 316 - "AmpouleVisual.tsx"
Cohesion: 0.08
Nodes (26): DosageFormIcon(), DosageFormIconProps, COMMON_DOSAGE_FORMS, DosageFormPicker(), DosageFormPickerProps, StackItemDetails(), StackItemDetailsProps, StackStage() (+18 more)
