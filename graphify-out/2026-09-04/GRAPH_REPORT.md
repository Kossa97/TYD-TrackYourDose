...
## Corpus Check
- 579 files · ~662,963 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3675 nodes · 6772 edges · 320 communities (209 shown, 111 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 60 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a64eeb85`
...
Cohesion: 0.07
Nodes (37): CarouselCounter(), CarouselPagination(), Cycle, isInjectableMethod(), ResolvedRoutineGroup, ScheduleSegment, buildDashboardRoutineIntake(), calendarLegendText (+29 more)
...
Cohesion: 0.08
Nodes (39): archiveStackItem(), deleteStackItem(), findDuplicate(), ingredientForSave(), itemParams(), loadStackItems(), nullableText(), planParams() (+31 more)
...
Cohesion: 0.05
Nodes (33): alertMessage(), ExpiryWarningBanners(), InjectionHeroPin, iconBoxBase, labelStyle, panelStyle, storageKey(), WORKFLOW_STEPS (+25 more)
...
Cohesion: 0.19
Nodes (15): LANGUAGES, applyTheme(), getThemeMode(), resolveTheme(), setThemeMode(), systemPrefersLight(), ThemeMode, useTheme() (+7 more)
...
Cohesion: 0.18
Nodes (16): PATCH_BODY, PATCH_FLAP_TIP, PATCH_FOLD_A, PATCH_FOLD_B, PATCH_NAME_PCT, PATCH_NAME_ZONE, PATCH_SPEC, PATCH_STRIPE (+8 more)
...
Cohesion: 0.08
Nodes (35): adjustmentStartDay(), buildDoseAdjustmentBackfillUpdates(), DoseAdjustmentBackfillLog, DoseAdjustmentBackfillUpdate, earliestAdjustmentStartDay(), logDay(), adjustment, cycle (+27 more)
...
Cohesion: 0.21
Nodes (11): numberValue(), ProductInventorySection(), ProductInventorySectionProps, emptyInventory, SubstanceSearchProps, STACK_CATEGORIES, StackCategoryDefinition, ConfigurationStatus (+3 more)
...
Cohesion: 0.16
Nodes (25): VialStageLightHandle, SloshContext, SloshProvider(), SloshEngine, StackStageProps, AmpouleRenderer(), AmpouleRendererProps, strengthLabel() (+17 more)
...
Cohesion: 0.18
Nodes (6): StackItemDetails(), StackItemDetailsProps, getDosageForm(), isStageRenderable(), LoadedLegacyStackItem, LoadedStackItem
...
Cohesion: 0.09
Nodes (24): PK_PROFILES, PkSeed, AuthContext, AuthContextType, AuthProvider(), getDateLocale(), loadDateLocale(), LOADERS (+16 more)
...
## Knowledge Gaps
- **1489 isolated node(s):** `SLOT_TIMES`, `WEEKDAYS_DE`, `REMINDER_OFFSETS_MIN`, `config`, `UIKit` (+1484 more)
...
- **Why does `useAuth()` connect `TodayLogSheet.tsx` to `MetricChart.tsx`, `Daily Logs & Effects`, `Design System Components`, `Admin Library Panel`, `Health Data Integration`, `Cycle Form & Vials`, `3D Injection Map`, `Home Dashboard`, `Injection Persistence`, `App Routing & Pages`, `Blood-Level Simulation`, `TS App Config`, `Blood-Level Carousel`, `Theme & Profile Settings`, `InjectionTrackerTabs.tsx`, `Push Notifications`, `Peptide Form Modal`, `intakeConfirmation.ts`, `BlutwertePage.tsx`, `Tagebuch.tsx`, `Gradle Build (app)`, `DesignSystem.tsx`, `Zyklus-Planung versionieren — „gilt ab Änderung" (Design)`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `supabase` connect `Tagebuch.tsx` to `MetricChart.tsx`, `PDF Protocol Export`, `Daily Logs & Effects`, `Design System Components`, `Admin Library Panel`, `Health Data Integration`, `Cycle Form & Vials`, `Auth & Supabase Client`, `Home Dashboard`, `Blood-Level Simulation`, `Cycle Seed Builder`, `Blood-Level History Curve`, `TS App Config`, `Blood-Level Carousel`, `Theme & Profile Settings`, `Live Blood-Level Chart`, `Push Notifications`, `Peptide Form Modal`, `BlutwertePage.tsx`, `Gradle Build (app)`, `TodayLogSheet.tsx`, `DesignSystem.tsx`, `injectionDeepLink.ts`?**
