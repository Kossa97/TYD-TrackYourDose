# Graph Report - my-stack-foundation  (2026-08-26)

## Corpus Check
- 514 files · ~600,728 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3273 nodes · 6043 edges · 305 communities (195 shown, 110 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 55 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `75577a5b`
...
- [[_COMMUNITY_Test|Test]]
- [[_COMMUNITY_MyStackPage.test.ts|MyStackPage.test.ts]]
...
1. `useAuth()` - 48 edges
2. `MyStackPage()` - 43 edges
3. `supabase` - 32 edges
4. `Dashboard()` - 29 edges
5. `TrackingLevel` - 28 edges
6. `Protokoll()` - 27 edges
7. `normalizeMarker()` - 22 edges
8. `File Structure` - 21 edges
9. `SubstanceCatalogEntry` - 20 edges
10. `Content Studio Sub-Projekt 1 (Content-Engine + Social-Posts) — Implementation Plan` - 20 edges
...
Cohesion: 0.16
Nodes (16): InjectionLogSheet(), InjectionSaveInput, InjectionSaveMode, METHOD_OPTIONS, toLocalInput(), UNIT_OPTIONS, areInjectionDetailsLocked(), InjectionEntryMode (+8 more)
...
Cohesion: 0.05
Nodes (30): alertMessage(), ExpiryWarningBanners(), FeatureFlag, FEATURES, ExpiryStatus, getPeptideExpiryAlerts(), PeptideExpiryAlert, PeptideExpirySource (+22 more)
...
Cohesion: 0.09
Nodes (24): resolvePkScheduleForDay(), useMediaQuery(), BlutspiegelSimulation(), CATEGORY_ACCENT, ChartPoint, computeSingleDose(), INPUT, LABEL (+16 more)
...
Cohesion: 0.12
Nodes (24): carouselMocks, cycles, LiveCycleCard(), calculateCurveTo(), calculateHistoryBlutspiegelCurve(), computeTrend(), cycleIntakeMinutes(), CycleRow (+16 more)
...
Cohesion: 0.11
Nodes (31): FOCUSABLE_SELECTOR, pkIntentSteps(), StackItemWizard(), STEP_LABELS, renderWizard(), evaluatePkReadiness(), normalizedText(), toPkMilligrams() (+23 more)

### Community 31 - "Language & Onboarding Context"
Cohesion: 0.10
Nodes (28): DosageFormPicker(), DosageFormPickerProps, FREQUENCIES, IntakePlanEditor(), IntakePlanEditorProps, METHODS, numericValue(), quantityLabel() (+20 more)
...
Cohesion: 0.19
Nodes (14): VialStageLightHandle, SloshContext, SloshProvider(), useSloshEngine(), clamp(), createSloshEngine(), SloshEngine, SloshState (+6 more)
...
Cohesion: 0.13
Nodes (20): CycleWithPk, TitrationStep, PkReadiness, PkReadinessInput, PkScheduleCycle, ResolvedPkSchedule, TrackingLevel, ScheduleSegment (+12 more)
...
Cohesion: 0.13
Nodes (26): InjectionIntroSheet(), assertInjectionProSchema(), buildInjectionInsertPayload(), buildSelectableInjectionIntakes(), confirmIntakeDoseLog(), cycleName(), doseLogSlotKey(), INJECTABLE_METHODS (+18 more)
...
Cohesion: 0.12
Nodes (21): SubstanceSearchProps, LEVELS, TrackingLevelPicker(), TrackingLevelPickerProps, STACK_CATEGORIES, StackCategoryDefinition, LoadedStackItemIngredient, CATALOG_COLUMNS (+13 more)
...
Cohesion: 0.22
Nodes (11): clamp01(), clampFill(), clampSlosh(), fillMotionShiftPct(), LIQUID_BUBBLES, PeptideVialVisual(), PeptideVialVisualProps, usePrefersReducedMotion() (+3 more)
...
Cohesion: 0.14
Nodes (22): collectMissedIntakes(), collectOpenIntakes(), cycleAppliesToDay(), cycleDaySlots(), effectiveDose(), findOldestOverdueIntake(), IntakeLog, MissedIntake (+14 more)
...
Cohesion: 0.09
Nodes (23): completeCatalogFlow(), completeCustomFlow(), continueWizard(), existingPlan, existingVitaminD, pkVitaminD3, reachExistingReview(), renderWizard() (+15 more)
...
Cohesion: 0.50
Nodes (3): Compatible restore repair - 2026-07-24, My Stack Backup Gate, Tracking-depth cutover checkpoint - 2026-08-17

### Community 284 - "MyStackPage.test.ts"
Cohesion: 0.21
...
### Community 288 - "InjektionsTracker.tsx"
Cohesion: 0.27
Nodes (9): debitPeptideStockForDoseById(), buildInjectionTrackerUrl(), findTargetInjectionIntake(), getOpenInjectionIntakeKey(), INJECTABLE_METHODS, isInjectableMethod(), OpenInjectionIntake, buildHomeRoutineIntake() (+1 more)

### Community 289 - "styles.ts"
Cohesion: 0.25
...
Cohesion: 0.21
Nodes (11): readyInput, adjustmentStartDay(), buildDoseAdjustmentBackfillUpdates(), DoseAdjustmentBackfillLog, DoseAdjustmentBackfillUpdate, earliestAdjustmentStartDay(), logDay(), adjustment (+3 more)
...
Cohesion: 0.38
Nodes (5): StackStage(), capsuleItem, renderStage(), vialItem, VialRenderer()
...
### Community 308 - "useFortschrittData.ts"
Cohesion: 0.27
...
## Knowledge Gaps
- **1302 isolated node(s):** `SLOT_TIMES`, `WEEKDAYS_DE`, `REMINDER_OFFSETS_MIN`, `config`, `UIKit` (+1297 more)
...
- **Why does `supabase` connect `Auth & Supabase Client` to `MetricChart.tsx`, `PDF Protocol Export`, `Daily Logs & Effects`, `Design System Components`, `Admin Library Panel`, `Health Data Integration`, `Cycle Form & Vials`, `React + TypeScript + Vite`, `Home Dashboard`, `App Routing & Pages`, `Blood-Level Simulation`, `Cycle Seed Builder`, `Blood-Level History Curve`, `Bloodwork Form`, `Blood-Level Carousel`, `Theme & Profile Settings`, `Live Blood-Level Chart`, `3D Injection Hero`, `Push Notifications`, `Vial Liquid Geometry`, `Public Profile Page`, `useFortschrittData.ts`, `Onboarding Callout Layout`, `DesignSystem.tsx`, `injectionDeepLink.ts`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Bloodwork Form` to `MetricChart.tsx`, `Daily Logs & Effects`, `Design System Components`, `Health Data Integration`, `Cycle Form & Vials`, `React + TypeScript + Vite`, `3D Injection Map`, `Auth & Supabase Client`, `Home Dashboard`, `App Routing & Pages`, `Blood-Level Simulation`, `MyStackPage.test.ts`, `InjektionsTracker.tsx`, `styles.ts`, `Blood-Level Carousel`, `Theme & Profile Settings`, `3D Injection Hero`, `Peptide Form Modal`, `Vial Liquid Geometry`, `useFortschrittData.ts`, `Onboarding Callout Layout`, `DesignSystem.tsx`, `Zyklus-Planung versionieren — „gilt ab Änderung" (Design)`?**
