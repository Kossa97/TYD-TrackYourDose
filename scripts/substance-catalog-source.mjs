...
export const SUBSTANCE_CATALOG = [
  ...
  { name: 'Koffein', aliases: ['Caffeine', 'Coffein'], category: 'supplement', dosageForms: ['tablet', 'capsule'], units: ['mg'], pkProfile: 'Koffein' },
  { name: 'L-Theanin', aliases: ['Theanin', 'L-Theanine'], category: 'supplement', dosageForms: ['capsule', 'tablet', 'powder'], units: ['mg'], pkProfile: 'L-Theanin' },
  ...
  { name: 'NAC', aliases: ['N-Acetyl-Cystein', 'N-Acetylcystein', 'Acetylcystein'], category: 'supplement', dosageForms: ['capsule', 'tablet'], units: ['mg'], pkProfile: 'NAC' },
  ...
  { name: '5-HTP', aliases: ['5-Hydroxytryptophan', 'Griffonia'], category: 'supplement', dosageForms: ['capsule', 'tablet'], units: ['mg'], pkProfile: '5-HTP' },
  ...
  { name: 'Omeprazol', aliases: ['Omeprazole'], category: 'medication', dosageForms: ['capsule', 'tablet'], units: ['mg'], pkProfile: 'Omeprazol' },
  { name: 'Atorvastatin', aliases: ['Sortis'], category: 'medication', dosageForms: ['tablet'], units: ['mg'], pkProfile: 'Atorvastatin' },
  { name: 'Rosuvastatin', aliases: ['Crestor'], category: 'medication', dosageForms: ['tablet'], units: ['mg'], pkProfile: 'Rosuvastatin' },
  { name: 'Simvastatin', aliases: ['Zocor'], category: 'medication', dosageForms: ['tablet'], units: ['mg'], pkProfile: 'Simvastatin' },
  { name: 'Ramipril', aliases: ['Delix'], category: 'medication', dosageForms: ['tablet', 'capsule'], units: ['mg'], pkProfile: 'Ramipril' },
  { name: 'Bisoprolol', aliases: ['Concor'], category: 'medication', dosageForms: ['tablet'], units: ['mg'], pkProfile: 'Bisoprolol' },
  { name: 'Metoprolol', aliases: ['Beloc'], category: 'medication', dosageForms: ['tablet'], units: ['mg'], pkProfile: 'Metoprolol' },
  { name: 'Amlodipin', aliases: ['Amlodipine', 'Norvasc'], category: 'medication', dosageForms: ['tablet', 'capsule'], units: ['mg'], pkProfile: 'Amlodipin' },
  { name: 'Candesartan', aliases: ['Blopress'], category: 'medication', dosageForms: ['tablet'], units: ['mg'], pkProfile: 'Candesartan' },
  { name: 'Sertralin', aliases: ['Sertraline', 'Zoloft'], category: 'medication', dosageForms: ['tablet'], units: ['mg'], pkProfile: 'Sertralin' },
  { name: 'Escitalopram', aliases: ['Cipralex'], category: 'medication', dosageForms: ['tablet'], units: ['mg'], pkProfile: 'Escitalopram' },
  { name: 'Venlafaxin', aliases: ['Venlafaxine', 'Trevilor'], category: 'medication', dosageForms: ['capsule', 'tablet'], units: ['mg'], pkProfile: 'Venlafaxin' },
  { name: 'Bupropion', aliases: ['Elontril', 'Wellbutrin'], category: 'medication', dosageForms: ['tablet'], units: ['mg'], pkProfile: 'Bupropion' },
  { name: 'Methylphenidat', aliases: ['Methylphenidate', 'Ritalin', 'Medikinet', 'Concerta'], category: 'medication', dosageForms: ['tablet', 'capsule'], units: ['mg'], pkProfile: 'Methylphenidat' },
  { name: 'Lisdexamfetamin', aliases: ['Lisdexamfetamine', 'Elvanse', 'Vyvanse'], category: 'medication', dosageForms: ['capsule'], units: ['mg'], pkProfile: 'Lisdexamfetamin' },
  { name: 'Modafinil', aliases: ['Vigil', 'Provigil'], category: 'medication', dosageForms: ['tablet'], units: ['mg'], pkProfile: 'Modafinil' },
  { name: 'Finasterid', aliases: ['Finasteride', 'Propecia'], category: 'medication', dosageForms: ['tablet'], units: ['mg'], pkProfile: 'Finasterid' },
  { name: 'Dutasterid', aliases: ['Dutasteride', 'Avodart'], category: 'medication', dosageForms: ['capsule'], units: ['mg'], pkProfile: 'Dutasterid' },
  { name: 'Tadalafil', aliases: ['Cialis'], category: 'medication', dosageForms: ['tablet'], units: ['mg'], pkProfile: 'Tadalafil' },
  { name: 'Sildenafil', aliases: ['Viagra'], category: 'medication', dosageForms: ['tablet'], units: ['mg'], pkProfile: 'Sildenafil' },
  { name: 'Anastrozol', aliases: ['Anastrozole', 'Arimidex'], category: 'medication', dosageForms: ['tablet'], units: ['mg'], pkProfile: 'Anastrozol' },
  { name: 'Tamoxifen', aliases: ['Nolvadex'], category: 'medication', dosageForms: ['tablet'], units: ['mg'], pkProfile: 'Tamoxifen' },
  { name: 'Enclomifen', aliases: ['Enclomiphene', 'Enclomifencitrat'], category: 'medication', dosageForms: ['capsule', 'tablet'], units: ['mg'], pkProfile: 'Enclomifen' },
  { name: 'Levothyroxin', aliases: ['Levothyroxine', 'L-Thyroxin', 'Euthyrox', 'T4'], category: 'medication', dosageForms: ['tablet'], units: ['mcg'], pkProfile: 'Levothyroxin' },
  { name: 'Liothyronin', aliases: ['Liothyronine', 'T3', 'Thybon'], category: 'medication', dosageForms: ['tablet'], units: ['mcg'], pkProfile: 'Liothyronin' },
  { name: 'Allopurinol', aliases: ['Zyloric'], category: 'medication', dosageForms: ['tablet'], units: ['mg'], pkProfile: 'Allopurinol' },
  { name: 'Cetirizin', aliases: ['Cetirizine', 'Zyrtec'], category: 'medication', dosageForms: ['tablet'], units: ['mg'], pkProfile: 'Cetirizin' },
  { name: 'Loratadin', aliases: ['Loratadine', 'Lorano'], category: 'medication', dosageForms: ['tablet'], units: ['mg'], pkProfile: 'Loratadin' },
  { name: 'Prednisolon', aliases: ['Prednisolone', 'Decortin H'], category: 'medication', dosageForms: ['tablet'], units: ['mg'], pkProfile: 'Prednisolon' },
  { name: 'Amoxicillin', aliases: ['Amoxi'], category: 'medication', dosageForms: ['capsule', 'tablet'], units: ['mg'], pkProfile: 'Amoxicillin' },
  { name: 'Dapagliflozin', aliases: ['Forxiga', 'Farxiga'], category: 'medication', dosageForms: ['tablet'], units: ['mg'], pkProfile: 'Dapagliflozin' },
  { name: 'Empagliflozin', aliases: ['Jardiance'], category: 'medication', dosageForms: ['tablet'], units: ['mg'], pkProfile: 'Empagliflozin' },
  { name: 'Naltrexon', aliases: ['Naltrexone', 'LDN', 'Low Dose Naltrexone'], category: 'medication', dosageForms: ['tablet', 'capsule'], units: ['mg'], pkProfile: 'Naltrexon' },
  { name: 'Rapamycin', aliases: ['Sirolimus', 'Rapamune'], category: 'medication', dosageForms: ['tablet'], units: ['mg'], pkProfile: 'Rapamycin' },
